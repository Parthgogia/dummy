// read values of IR sensorusinganaloganddigitalread
//  and convert buggy into normal line follower robo car.
void setup()
{
    pinMode(A0, INPUT);
    pinMode(A2, INPUT);
...
// Todemonstratetheuseofultrasonicsensorbyintegratinglinefollower
